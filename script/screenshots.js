                ...
                .then(function () {
                    ...
                    if (cfg.browserName === 'MicrosoftEdge') {
                        return browserDriver
                            .getWindowSize()
                            .then(function (size) {
                                return browserDriver.setWindowSize(
                                    size.width,
                                    size.height
                                );
                            })
                            .then(
                                willLog(
                                    sessionName,
                                    'reset window size (Edge-only workaround)'
                                )
                            );
                    }
                })
