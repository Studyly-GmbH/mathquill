suite('up/down', function () {
    ...
    test('up/down in out of exponent', function () {
        ...
        assert.equal(
            cursor.parent,
            expBlock,
            'cursor up left stays in exponent'
        );
    ...
    test('up/down in out of subscript', function () {
        ...
        assert.equal(
            cursor.parent,
            subBlock,
            'cursor down goes into subscript'
        );
    ...
    test('integral in exponent', function () {
        ...
        assert.equal(
            cursor.parent.latex(),
            '0',
            'cursor down goes to lower limit'
        );
