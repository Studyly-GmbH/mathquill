suite('backspace', function () {
    ...
    test('backspace through text block', function () {
        ...
        assert.equal(
            cursor[R],
            0,
            'cursor is at the right end of the text block'
        );
        assert.equal(
            cursor[L],
            0,
            'cursor is at the left end of the text block'
        );
        ...
        assert.equal(
            cursor[R],
            0,
            'cursor is at the right end of the root block'
        );
        assert.equal(
            cursor[L],
            0,
            'cursor is at the left end of the root block'
        );
        assert.equal(mq.latex(), '');
    });
