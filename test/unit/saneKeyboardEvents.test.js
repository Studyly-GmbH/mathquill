        ...
        saneKeyboardEvents(
            ...
            mockController({
                keystroke: function (key, keydown) {
                    ...
                    assert.ok(
                        counter <= 3,
                        'callback is called at most 3 times'
                    );
                ...
                suite(
                    ...
                    function () {
                        test('without keypress', function () {
                            ...
                            assert.ok(
                                el[0].selectionStart !== el[0].selectionEnd
                            );
                        ...
                        test('with keypress, many characters selected', function () {
                            ...
                            trigger.keypress(el[0], 'ArrowLeft', {
                                altKey: true
                            });
                            el[0].selectionEnd = 0;
